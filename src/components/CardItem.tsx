...
import {addItem, minusItem, plusItem, removeItem} from '../bll/slises/cart/cartSlice';
...
export const CardItem = ({id, price, count, imageUrl, title, type, size}: CartItemPropsType) => {
